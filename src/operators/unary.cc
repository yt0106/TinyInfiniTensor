...
namespace infini
{
    ...
    optional<vector<Shape>> ClipObj::inferShape(const TensorVec &inputs)
    {
        ...
        // =================================== 作业 ===================================
        const auto A = inputs[0];
        auto input_dim = A->getDims(); // return shape;
    ...
    vector<DataType> CastObj::inferDataType(const TensorVec &inputs) const
    {
        ...
        // =================================== 作业 ===================================
        //DataType output_type = outputs[0]->getDType();
        DataType output_type = getOutputDataType();
        return vector(numOutputs(), output_type);
    }
